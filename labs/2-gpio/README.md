...
***NOTE: this is being rewritten for clarify: but the basic tasks will remain the same.***
...
**Important**: 
 ...
 - For today only you'll have to hit the power-button on the parthiv board
   ...
   yet have a reboot.)
 - If you're getting an error with <string.h> on Mac and it's loading
   something that includes like MacSDK, set your CPATH env variable to empty
