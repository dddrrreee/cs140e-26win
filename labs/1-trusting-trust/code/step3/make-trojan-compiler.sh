...
# echo "PASSES (Mac does the weird thing where it is not equal if I do the check.\nMaybe running in UTM VM will help)"
# ./cc-attacked ../step2/compiler.c -o cc-attacked
# ./cc-attacked ../step2/compiler.c -o cc-attacked
# ./cc-attacked ../step2/compiler.c -o cc-attacked
# ./cc-attacked ../step2/compiler.c -o cc-attacked
