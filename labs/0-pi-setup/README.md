...
------------------------------------------------------------------------
## 5. Set your `CS140E_2026_PATH`

Checkoff:
   - Typing:

            cd $CS140E_2026_PATH/labs/0-pi-setup
...
`CS140E_2026_PATH` to contain where you have your class repository.
...
E.g., for me, since I'm running `tcsh` I edit my `.tcshrc` file and add:
    ...
    setenv CS140E_2026_PATH /home/engler/class/cs140e-25win/

To the end of it.  If you use `bash` you'll do an:

    export CS140E_2026_PATH=<path to your repo>
...
If this doesn't work:
  ...
  2. You mispelled `CS140E_2026_PATH` or gave it the wrong path.
