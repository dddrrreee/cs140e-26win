...
#define W5500_MAX_RW_BUF_SIZE 64

/* ---------- Control Phase (p. 15-16) ---------- */
enum {
    W5500_BLK_COMMON            = 0b00000,

    W5500_BLK_SOCKET_0          = 0b000 << 5, // Use with REG/TX_BUF/RX_BUF
    W5500_BLK_SOCKET_1          = 0b001 << 5, // Use with REG/TX_BUF/RX_BUF
    W5500_BLK_SOCKET_2          = 0b010 << 5, // Use with REG/TX_BUF/RX_BUF
    W5500_BLK_SOCKET_3          = 0b011 << 5, // Use with REG/TX_BUF/RX_BUF
    W5500_BLK_SOCKET_4          = 0b100 << 5, // Use with REG/TX_BUF/RX_BUF
    W5500_BLK_SOCKET_5          = 0b101 << 5, // Use with REG/TX_BUF/RX_BUF
    W5500_BLK_SOCKET_6          = 0b110 << 5, // Use with REG/TX_BUF/RX_BUF
    W5500_BLK_SOCKET_7          = 0b111 << 5, // Use with REG/TX_BUF/RX_BUF

    W5500_SOCKET_REG            = 0b01 << 3,
    W5500_SOCKET_TX_BUF         = 0b10 << 3,
    W5500_SOCKET_RX_BUF         = 0b11 << 3,
...
enum {
    W5500_Sn_MR                 = 0x0000, // Socket Mode
    ...
    W5500_Sn_REG_TX_RD0         = 0x0022, // Socket TX Buffer Write Pointer (2 bytes)
    W5500_Sn_REG_TX_WR0         = 0x0024, // Socket TX Buffer Read Pointer (2 bytes)

    W5500_Sn_REG_RX_FSR0        = 0x0026, // Socket RX Buffer Free Size (2 bytes)
    W5500_Sn_REG_RX_RD0         = 0x0028, // Socket RX Buffer Write Pointer (2 bytes)
    W5500_Sn_REG_RX_WR0         = 0x002A, // Socket RX Buffer Read Pointer (2 bytes)
...
enum {
    ...
    W5500_PING_BLOCK_EN         = 1 << 4, // Ignores PING requests
    ...
    W5500_FORCE_ARP_EN          = 1 << 1, // Send ARP IMMEDIATELY
};
...
enum W5500 {
    ...
    W5500_100BT_HALF_DUP_AUTO_NEG_EN  // PHY Mode
        = 0b100 << 3,
    W5500_ALL_CAPBLE_AUTO_NEG_EN      // PHY Mode
        = 0b111 << 3,
